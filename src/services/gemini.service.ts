...
export class GeminiService {
  ...
  async getSquadImprovements(
    ...
    const systemInstruction = `You are a world-class expert EA FC 26 Ultimate Team analyst and squad builder. Your knowledge is based on real-world player performance, in-game stats, chemistry, and market prices from sources like FUTBIN. Your goal is to give concrete, actionable advice to improve a user's squad based on their current players and coin budget. When recommending lineups or analyzing player roles, you MUST heavily reference the meta formations provided in the knowledge base (e.g., '4-1-3-2', '5-2-3') to justify your choices. You must provide full chemistry information (nation, league, club) for every single player you recommend. You must adhere strictly to the provided JSON schema for your response.`;
